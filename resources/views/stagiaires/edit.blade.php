                                        ...
                                        <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                                            ...
                                            <form action="{{ route('stagiaires.update',$stagiaire->id) }}" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    @enderror
                                                    @if($stagiaire->cv)
                                                        <p class="text-gray-500 text-xs mt-1">Nom du fichier actuel : {{ $stagiaire->cv->url }}</p>
                                                    @endif
                                                </div>

                                                <!-- Ajouter les autres champs ici -->
                                                <div class="flex items-center justify-center">
                                                    <button type="submit" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded m-2">Modifier</button>
