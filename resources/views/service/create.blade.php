                                ...
                                <div class="flex justify-center">
                                    <div class="w-full sm:w-2/3 lg:w-1/2 xl:w-1/3">
                                        <div class="bg-white shadow-md rounded-lg p-8">
                                            ...
                                            <form action="{{ route('services.store') }}" method="POST" class="max-w-md mx-auto bg-white p-6 rounded-lg shadow-md">
                                                @csrf

                                                <label for="libelle" class="block font-bold mb-2">Libellé du service:</label>
                                                ...
                                                <div class="flex justify-between">
                                                    ...
                                                    <button type="button" onclick="window.location='{{ route("services.index") }}'" class="w-48 px-4 py-2 bg-red-500 text-white font-semibold rounded-lg hover:bg-red-600">Annuler</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
